...
class fakeData: NSObject {
    ...
    func getData(int: Int?) -> NSDictionary {
        ...
        fakeDictionary["image_url"] = "http://res.cloudinary.com/hrscywv4p/image/upload/c_limit,f_auto,h_3000,q_90,w_1200/Luvocracy_327_1_x8yw9e.jpg"
        ...
        fakeDictionary["rating_average"] = int!%5
